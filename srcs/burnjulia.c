...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/04 14:43:20 by lojesu            #+#    #+#             */
/*   Updated: 2019/05/06 15:16:23 by lojesu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_calcul(t_win *win, t_val *val, t_zoom *zoom, t_pos *pos)
{
	...
	{
		thd.x_1 = fabs(pow(thd.width, 2) - pow(thd.height, 2) + val->cx);
		thd.y_1 = fabs(2 * thd.width * thd.height + val->cy);
