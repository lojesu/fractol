...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/03 17:37:21 by lojesu            #+#    #+#             */
/*   Updated: 2019/05/02 18:02:11 by lojesu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_calcul(t_win *win, t_val *val, t_zoom *zoom, t_pos *pos)
{
	...
	{
		thd.x_1 = pow(thd.x, 3) - 3 * thd.x * pow(thd.y, 2) + thd.width;
		thd.y_1 = 3 * pow(thd.x, 2) * thd.y - pow(thd.y, 3) + thd.height;
