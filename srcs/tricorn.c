...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/03 18:04:18 by lojesu            #+#    #+#             */
/*   Updated: 2019/05/02 18:02:59 by lojesu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_calcul(t_win *win, t_val *val, t_zoom *zoom, t_pos *pos)
{
	...
	{
		thd.x_1 = pow(thd.x, 2) - pow(thd.y, 2) + thd.width;
		thd.y_1 = -1 * (thd.x * thd.y * 2) + thd.height;
